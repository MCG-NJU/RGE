...
class DataArguments:
    ...
    dataset_split: str = field(
        default='original', metadata={"help": "dataset split"}
    )
    ...
    instruction_replacements: str = field(
        default="./src/instruction_replacements.yaml", metadata={"help": "instruction replacements"}
    )
    candidate_replacements: str = field(
        default="./src/candidate_replacements.yaml", metadata={"help": "candidate replacements"}
    )
...
class TrainingArguments(TrainingArguments):
    ...
    generation_max_new_tokens: int = field(
        default=256, metadata={"help": "generation max new tokens"})
    ...
    ar_weight: float = field(
        default=1.0, metadata={"help": "AR weight"})
    emb_weight: float = field(
        default=1.0, metadata={"help": "Embedding weight"})
